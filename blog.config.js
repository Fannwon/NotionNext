...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名艺术者, Hi，我是一个搬砖人,Hi，我是一个终生学习的人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '春田花花疯人院', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个沉浮于红尘之中的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://so.ikun.su/', // 网站地址
